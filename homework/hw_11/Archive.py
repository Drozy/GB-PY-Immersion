...
и number в архив (списки archive_text и archive_number) для уже существующего экземпляра. Если экземпляр
еще не существует, метод создает новый экземпляр класса Archive с пустыми архивами для текстовых
...
class Archive:
    """
    Класс Архив для хранения текстовых и числовых записей, реализованный по принципу Singleton
    """
    _instance = None
    ...
    def __init__(self, text, number):
        """
        При инициализации экземпляра класса входные значения сохраняются в списки-архивы
        :param text: any text
...
if __name__ == '__main__':
    print(Archive("Запись 1", 42))
    print(Archive("Запись 2", 3.14))
