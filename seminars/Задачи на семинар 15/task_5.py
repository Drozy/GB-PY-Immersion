...
# запуск командной строкой:python Seminar15/task_5.py -cnt=3-я -wd='среда'
# запуск командной строкой:python Seminar15/task_5.py -cnt=3-я -wd=1
# запуск командной строкой:python Seminar15/task_5.py -cnt=3-я -wd=2 -m=7
